...
public class Constants {
    ...
    //Default values
    public static final String DEFAULT_USERNAME = "or";
    public static final String DEFAULT_GROUP =  "araiot_test";
    ...
    public static final int DEFAULT_TRACKING_INTERVAL = 2;
    ...
    public static final String TRACK_BCAST = "com.example.track";
